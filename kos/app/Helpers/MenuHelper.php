...
class MenuHelper
{
        ...
        if ($role === 'super_admin') {
            return [
                [
                    'icon' => 'dashboard',
                    'name' => 'Dashboard',
                    'path' => route('super-admin.dashboard'),
                ],
                [
                    'icon' => 'users',
                    'name' => 'Manajemen User',
                ...
                [
                    'icon' => 'payment',
                    'name' => 'Laporan Global',
                    'path' => route('super-admin.reports'),
                ],
                [
                    'icon' => 'settings',
                    'name' => 'Setting',
    ...
    public static function getOthersItems()
    {
        return [
            [
                ...
                'name' => 'Charts',
                'subItems' => [
                    ['name' => 'Line Chart', 'path' => route('super-admin.charts.line'), 'pro' => false],
                    ['name' => 'Bar Chart', 'path' => route('super-admin.charts.bar'), 'pro' => false]
                ],
            ],
            [
                'icon' => 'ui-elements',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'users' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5s-3 1.34-3 3 1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" fill="currentColor"/></svg>',
            'property' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 21H21V19H3V21ZM5 17H7V13H5V17ZM9 17H11V9H9V17ZM13 17H15V13H13V17ZM17 17H19V5H17V17Z" fill="currentColor"/></svg>',
            'payment' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 7H3C1.89 7 1 7.89 1 9V17C1 18.11 1.89 19 3 19H21C22.11 19 23 18.11 23 17V9C23 7.89 22.11 7 21 7ZM21 17H3V13H21V17ZM21 11H3V9H21V11Z" fill="currentColor"/></svg>',
