                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="username" name="username" value="{{ old('username') }}" placeholder="Enter your username"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" required autofocus />
                                        @error('username')
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <input type="checkbox" name="remember" id="remember"
                                                class="h-4 w-4 rounded-sm border-gray-300 text-brand-500 focus:ring-brand-500/20" />
                                            <label for="remember" class="text-sm text-gray-500 dark:text-gray-400">
                                                Keep me logged in
                                            </label>
                                        </div>
                                        <a href="#" class="text-sm font-medium text-brand-500 hover:text-brand-600">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <!-- Submit Button -->
                                    <div>
                                        <button type="submit"
                                            class="flex w-full items-center justify-center rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-brand-600">
                                            Sign In
                                        </button>
                                    </div>
                                </div>
